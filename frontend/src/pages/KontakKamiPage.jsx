...
function ContactHighlightIcon({ type }) {
  if (type === 'clock') {
    return (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" role="presentation" aria-hidden="true">
      ...
      <SectionReveal className="contact-hero-premium" data-nav-hero>
        ...
        <div className="container contact-hero-grid">
          <div className="contact-hero-copy">
            ...
            >
              <a className="btn contact-wa-hero-btn" href={whatsappChatDirectUrl} target="_blank" rel="noreferrer">
                <span className="contact-wa-hero-icon"><WhatsAppIcon /></span>
                Chat WhatsApp Langsung
              </a>
              <Link className="btn outline" to="/layanan">Lihat Layanan</Link>
            </motion.div>
          </div>
      ...
      <SectionReveal className="section contact-main-section">
        <div className="container">
          <div className="contact-main-head">
            ...
            <h2 className="contact-main-title">Ceritakan Kebutuhan Proyek Anda</h2>
            <p className="muted contact-main-subtitle">
              Isi formulir di bawah dan pesan akan dikirim langsung ke WhatsApp tim Trimitra untuk respon yang lebih cepat.
            </p>
          </div>
          ...
          <StaggerGroup className="contact-shell contact-shell-premium">
            <form className="contact-form card" onSubmit={handleSubmit} id="contact-form">
              <div className="contact-form-badge">
                <span className="contact-form-badge-icon"><WhatsAppIcon /></span>
              ...
              <button
                ...
                id="contact-submit"
              >
                <span className="contact-submit-icon"><WhatsAppIcon /></span>
                {isSubmitting ? 'Mengirim...' : submitLabel}
              </button>
              <p className="contact-form-note">
                * Data Anda akan dikirim langsung ke WhatsApp +62811-1098-42 dan tidak disimpan di server.
              </p>
            </form>
            ...
            <div className="contact-info">
              ...
              <article className="contact-box">
                ...
                <div>
                  ...
                  <p className="kicker"><a href={whatsappChatDirectUrl} target="_blank" rel="noreferrer">Chat WhatsApp →</a></p>
                </div>
              </article>
              ...
              <article className="contact-whatsapp-banner">
                <div className="contact-wa-banner-head">
                  <span className="contact-wa-banner-icon"><WhatsAppIcon /></span>
                  <div>
                    <p className="kicker">Fast Response</p>
                    <h3>Butuh Respon Cepat via WhatsApp?</h3>
                  </div>
                </div>
                <p className="muted">Tim kami siap merespon dalam waktu kurang dari 2 jam pada jam kerja.</p>
                <a
        ...
        <div className="container contact-cta-shell">
          <div>
            ...
            <p className="muted contact-cta-copy">
              Konsultasikan kebutuhan booth, event, dan media outdoor Anda bersama tim Trimitra untuk eksekusi yang lebih presisi dan tepat waktu.
            </p>
          </div>
          <div className="contact-cta-actions">
            <Link className="btn" to="/layanan">Lihat Layanan</Link>
            <Link className="btn outline home-cta-secondary" to="/galeri">Lihat Portofolio</Link>
          </div>
        </div>
      </SectionReveal>
    </div>
