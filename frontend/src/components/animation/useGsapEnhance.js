  ...
  useLayoutEffect(() => {
    ...
    const init = async () => {
      ...
      const pageSections = gsap.utils.toArray(
        'main .section:not([data-gsap-enhance="off"]), main .about-hero, main .gallery-hero, main .berita-hero, main .services-redesign-hero, main .contact-hero, main .contact-hero-premium, main .dark-cta',
      )
